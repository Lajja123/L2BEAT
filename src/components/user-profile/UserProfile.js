...
function UserProfile(props) {
  ...
  const openPricing = () => {
        ...
        style={{
          ...
          flexDirection:"column"
            ...
            <img
              src={User}
              alt={""}
              style={{ width: "80px",borderRadius:"50px", backgroundColor:"white"}}
            />
            ...
            <div style={{fontSize:"13px",lineHeight:"1.5rem",textAlign:"left",padding:"5px"}}>
          Received Delegations: 35068
            ...
            <div style={{fontSize:"13px",lineHeight:"1.5rem",textAlign:"left",padding:"5px"}}> {truncateAddress("0x257f25B70Baf79a846D54a8B41e7bE4A0b004e9F")}</div>
          ...
          <div class="col-md-9 mp-sec2">
            ...
            Set Your Availability <img src={cel} style={{background:"white",borderRadius:"20px",padding:"5px",width:"40px"}} onClick={handleCelClick}></img>
            <div>
   ...
   <button onClick={openAppInfo} className="listapi-tabBtn"  style={{
                      ...
                      "--tw-text-opacity": 1,
                      borderBottom:activeButton==="hours"?"1px solid #b0f127":"1px solid white",
                      
                      background:
                        activeButton === "hours" ? "none" : "none"}}
                        >
          Office Hours
        </button>
        <button onClick={openDocumentation} className="listapi-tabBtn"  style={{
                       ...
                       "--tw-text-opacity": 1,
                       borderBottom:activeButton==="call"?"1px solid #b0f127":"1px solid white",
                       
                       background:
                         activeButton === "call" ? "none" : "none",margin:"0px 20px"}}>
          Past Calls
        </button> 
