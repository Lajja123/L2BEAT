  ...
  useEffect(() => {
    ...
    <div className='single-dao'>
      ...
      <div style={{ margin: "30px auto", display: "flex", width:"75%"}}>
        <button onClick={openAppInfo} className="listapi-tabBtn"  style={{
                      color: activeButton === "delegate" ? "#b0f127" : "white",
                      "--tw-text-opacity": 1,
                      borderBottom:activeButton==="delegate"?"1px solid #b0f127":"1px solid white",
                      
                      background:
                        activeButton === "delegate" ? "none" : "none"}}
                        >
          Delegates
        </button>
        <button onClick={openDocumentation} className="listapi-tabBtn"  style={{
                       color: activeButton === "hour" ? "#b0f127" : "white",
                       "--tw-text-opacity": 1,
                       borderBottom:activeButton==="hour"?"1px solid #b0f127":"1px solid white",
                       
                       background:
                         activeButton === "hour" ? "none" : "none",margin:"0px 20px"}}>
          Office Hours
        </button>
      ...
      <div className="dashboard-main">
        ...
        <>
          {isAppInfoOpen && (
             <div className="dashboard-main" style={{width:"75%",margin:"0 auto"}}>
            ...
            >
              <div className="dao-flex">
                ...
                <p className="description-member" style={{padding:"10px 10px 0px 10px"}}>
                  {dao.description}
                </p>
            
              <div style={{width:"100%",padding:"0px 50px 0px 0px"}}>
          ...
          {isDocumentOpen && (
            ...
            {data.map((dao, index) => (
           <div class="api-card-office" style={{padding:"20px",marginTop:"0px",flexDirection:"row"}} >
...
<source src={call} type="video/mp4"/>
           ...
           <div class="card-body profile-card">
             <h5 class="card-title"style={{letterSpacing:"1px"}}>{dao.name}</h5>
             <p class="card-text description" style={{textAlign:"left",padding:"0px",letterSpacing:"1px"}}>Plutus is a delegate for Arbitrum & Optimism. Plutus Office Hour is every 14 days.</p>
